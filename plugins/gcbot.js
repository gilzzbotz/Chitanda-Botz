let fetch = require('node-fetch') 
 ...
         let caption = ` 
 *Join juga group official Chii-Botz* 
 ...
 *Group 3* 
 ...
             externalAdReply: { 
               sourceUrl: 'https://linki.ee/xzennz_', 
 ...
     } catch (e) { 
         let tulisan = ` 
 *Join Juga Group Official Chii - Bot!* 
Sekedar meramaikan, atau juga jika ada informasi mengenai bot. 
  
 *Group 1* 
https://chat.whatsapp.com/BAVS6dAFfYCDp6m7dELp5s
 ...
     await conn.sendButtonDoc(m.chat, tulisan.trim(), 'Harap patuhi rules dan peraturan pada masing masing group ya! Terimakasih.', 'Rules', '.rules', m, {
    ...
    contextInfo: { forwardingScore: 99999, isForwarded: true,
        externalAdReply: {
        	sourceUrl: 'https://vm.tiktok.com/ZSRpsRPL1/',
            title: 'Gruop Official',
            body: 'Chii - Botz © 2022',
          thumbnail: await (await fetch('https://telegra.ph/file/8c27118e1b45667879ffc.jpg')).buffer()
        }
     }
    })
 } 
